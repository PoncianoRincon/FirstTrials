...
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            absence_reason_1 = reason_columns.loc[:,1:14].max(axis=1)
            absence_reason_2 = reason_columns.loc[:,15:17].max(axis=1)
            absence_reason_3 = reason_columns.loc[:,18:21].max(axis=1)
            absence_reason_4 = reason_columns.loc[:,22:].max(axis=1)
            ...
            df = pd.concat([df, absence_reason_1, 
                            absence_reason_2, 
                            absence_reason_3, 
                            absence_reason_4], axis = 1)
            ...
            column_names = ['Date', 'Transportation Expense', 'Distance to Work', 'Age',
                           ...
                           'Pets', 'Absenteeism Time in Hours', 'absence_reason_1', 'absence_reason_2', 'absence_reason_3', 'absence_reason_4']
            df.columns = column_names

            # re-order the columns in df
            column_names_reordered = ['absence_reason_1', 'absence_reason_2', 'absence_reason_3', 'absence_reason_4', 'Date', 'Transportation Expense', 
            ...
            # re-order the columns in df
            column_names_upd = ['absence_reason_1', 'absence_reason_2', 'absence_reason_3', 'absence_reason_4', 'Month value', 'Day of the week',
